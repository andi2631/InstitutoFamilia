...
const CursoMatrimonioDescription: React.FC = () => {
  return (
    <div className="text-lg text-gray-700 leading-relaxed">
      <h3 className="text-2xl text-blue-800 my-4 text-center mx-auto">
        <em>Encuentros prematrimoniales</em>
      </h3>
      <p className="my-2">
        <strong>Preparación para construir un matrimonio sólido</strong>
      </p>
      <p>
        Cimientos es un programa de cinco encuentros prematrimoniales diseñado
      ...
      <ul className="list-disc pl-6 mt-2">
        ...
        <li>
          ...
          una economía sólida juntos.
        </li>
        <li>
          <strong>Autoestima en la pareja:</strong> Cuidando el bienestar
          emocional de ambos.
        </li>
        <li>
          <strong>Proyecto de vida compartido:</strong> Construyendo un futuro
          juntos.
        </li>
        <li>
          <strong>Las diferencias entre el hombre y la mujer:</strong> Cómo
      ...
      <p>
        El curso se realiza <strong>dos veces al año</strong>, al inicio de cada
      ...
      <p className="mt-2">
        ...
        esta gran vocación y conocer el plan de Dios para cada familia. Para más
        información e inscripciones, no dudes en ponerte en contacto con
        nosotros.
      </p>
      <h3 className="text-xl font-semibold mt-4">
